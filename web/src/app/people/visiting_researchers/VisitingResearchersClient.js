...
export default function VisitingResearchersClient({ staffData = [] }) {
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 bg-white dark:bg-gray-950 text-black dark:text-white rounded-lg shadow-lg">
      ...
      >
        We welcome visiting scholars collaborating on projects and knowledge exchange.
      </motion.p>
      ...
      {sorted.length === 0 ? (
        ...
        >
          No visiting researchers listed yet.
        </motion.p>
      ) : (
        <motion.div
