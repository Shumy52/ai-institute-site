      ...
      <div className="container mx-auto p-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="flex flex-col items-center">
          <ul>
            ...
            <li><a href="https://didatec-my.sharepoint.com/:f:/g/personal/airi_campus_utcluj_ro/IgBfIIZeG9p5SJ_Pde6NBWT5AU_tSajIkfRPaloVwavKIJ4?e=RQExCP" className="underline" target="_blank" rel="noopener noreferrer">Dissemination</a></li>
