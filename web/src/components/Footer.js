      ...
      <div className="container mx-auto p-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="flex flex-col items-center">
          <ul>
            ...
            <li><a href="https://didatec-my.sharepoint.com/personal/airi_campus_utcluj_ro/_layouts/15/onedrive.aspx?id=%2Fpersonal%2Fairi%5Fcampus%5Futcluj%5Fro%2FDocuments%2FAIRi%2Don%2DDemand%20%E2%80%93%20Communication%20and%20Dissemination%20Materials&ga=1" className="underline" target="_blank" rel="noopener noreferrer">Dissemination</a></li>
