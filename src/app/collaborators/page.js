...
const customIcon = new L.Icon({
  iconUrl: "/collabolators/uni-icon.png", // Ensure this path points to your custom marker icon
  iconSize: [48, 48],
  iconAnchor: [12, 41],
  popupAnchor: [1, -34],
...
const universities = [
  {
    name: "Technical University of Cluj-Napoca (That's us!)",
    lat: 46.769379,
    lon: 23.585384,
